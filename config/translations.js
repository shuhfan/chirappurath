...
const translations = {
  ...
  about_para5_en: 'Through the five sons of Varki, the head of the Kuzhimattam branch, five sub-branches were formed: Naduvileddam, Karanikulam, Kizhakkekkurt, Chelachira, and Valyavettil. Through the seven sons of Kuruvila, the head of the thottakad branch, seven sub-branches were formed: Thanukkumpathiykkol, Kizhakkemuriyil, Chirathalaykkol, Mattathil, Thanukkumpathiykkol East, Thanukkumpathiykkol West, and Chirappurath.',

  about_para6_ml: 'തോട്ടയ്ക്കാട്, കുഴിമറ്റം പ്രദേശത്തും കൂടാതെ കുമളി, മലബാർ മേഖലകളിലും കേരളത്തിൻ്റെ മറ്റു പ്രദേശങ്ങളിലും ഇന്ത്യയുടെ വിവിധ സംസ്ഥാങ്ങളിലും ലോകത്തിൻ്റെ പല രാജ്യങ്ങളിലും ആയി    അഞ്ചൂറിൽ അധികം കുടുംബങ്ങൾ പാർക്കുന്നു.',
