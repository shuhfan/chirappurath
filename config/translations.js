...
const translations = {
  // Hero Section
  hero_subtitle_ml: 'വിശ്വാസവും പാരമ്പര്യവും ഒരുമിച്ചൊരു കുടുംബചരിത്രം',
  hero_subtitle_en: 'A Heritage of Faith, Tradition, and Family',
  ...
  news_events_ml: 'വാർത്തകളും പരിപാടികളും',
  ...
  thottaykkad_branch_en: 'Thottakad Branch',

  // Buttons
  read_more_ml: 'കൂടുതൽ വായിക്കുക',
  read_more_en: 'Read More',

  view_all_news_ml: 'എല്ലാ വാർത്തകളും കാണുക',
  view_all_news_en: 'View All News',

  no_news_ml: 'താമസിയാതെ വാർത്തകൾ പ്രസിദ്ധീകരിക്കും',
  no_news_en: 'News will be published soon',

  // Navigation
  home_ml: 'ഹോം',
  home_en: 'Home',

  about_family_ml: 'കുടുംബത്തെക്കുറിച്ച്',
  about_family_en: 'About Family',

  branches_ml: 'ശാഖകൾ',
  branches_en: 'Branches',

  directory_ml: 'ഡയറക്ടറി',
  directory_en: 'Directory',

  family_tree_ml: 'കുടുംബവൃക്ഷം',
  family_tree_en: 'Family Tree',

  gallery_ml: 'ഗാലറി',
  gallery_en: 'Gallery',

  contact_us_ml: 'ബന്ധപ്പെടുക',
  ...
  // Sub-branches (Thottakad)
  thanukkumpathiykkol_ml: 'തണുങ്ങുംപതിയ്ക്കൽ',
  thanukkumpathiykkol_en: 'Thanangumpathickal',

  kizhakkemuriyil_ml: 'കിഴക്കേ മുറിയിൽ',
  kizhakkemuriyil_en: 'Kizhakkemuri',

  chirathalaykkol_ml: 'ചിറത്തലയ്ക്കൽ',
  chirathalaykkol_en: 'Chirathalakkal',

  mattathil_ml: 'മറ്റത്തിൽ',
  mattathil_en: 'Mattathil',

  thanukkumpathiykkol_east_ml: 'തണുങ്ങുംപതിയ്ക്കൽ (കിഴക്ക്)',
  thanukkumpathiykkol_east_en: 'Thanangumpathickal (East)',

  thanukkumpathiykkol_west_ml: 'തണുങ്ങുംപതിയ്ക്കൽ (പടിഞ്ഞാറ്)',
  thanukkumpathiykkol_west_en: 'Thanangumpathickal (West)',
  ...
  announcements_ml: 'അറിയിപ്പുകൾ',
  announcements_en: 'Announcements',

  obituary_ml: 'മരണവാർത്ത',
  obituary_en: 'Obituary',

  // Footer
  links_ml: 'ലിങ്കുകൾ',
  links_en: 'Links',

  gallery_updates_ml: 'ഗാലറിയും അപ്ഡേറ്റുകളും',
  gallery_updates_en: 'Gallery & Updates',
  ...
  history_para2_en: 'The Chirappurath family, one of the prominent families in Central Travancore, has two branches: Thottakad and Kuzhimattam. Varki, the third son of Chirappurath Kuruvila (seventh generation of Kalli household Kuruvila who settled in Thottakad), became the head of the Kuzhimattam branch, and his younger son Kuruvila became the head of the Thottakad branch. The other three ancestors had only daughters, who were married into the Padinjaremurei, Kadappoor, and Kannozhukam families respectively.',

  history_para3_ml: 'കുഴിമറ്റം ശാഖയിൽ അഞ്ച് പിതാക്കന്മാരിലൂടെ നടുവിലേടം, കാരാണിക്കുളം, കിഴക്കേക്കുറ്റ്, ചേലചിറ, വല്യവീട്ടിൽ എന്നീ അഞ്ച് ഉപശാഖകളും തോട്ടയ്ക്കാട് ശാഖയിൽ ഏഴ് പിതാക്കന്മാരിലൂടെ തണുങ്ങുംപതിയ്ക്കൽ, കിഴക്കേ മുറിയിൽ, ചിറത്തലയ്ക്കൽ, മറ്റത്തിൽ, തണുങ്ങുംപതിയ്ക്കൽ കിഴക്ക്, തണുങ്ങുംപതിയ്ക്കൽ പടിഞ്ഞാറ്, ചിറപ്പുറത്ത് എന്നീ ഏഴ് ഉപശാഖകളും ഉണ്ട് തോട്ടയ്ക്കാട്, കുഴിമറ്റം പ്രദേശത്തും കൂടാതെ കുമളി, മലബാർ മേഖലകളിലും കേരളത്തിൻ്റെ മറ്റു പ്രദേശങ്ങളിലും ഇന്ത്യയുടെ വിവിധ സംസ്ഥാങ്ങളിലും ലോകത്തിൻ്റെ പല രാജ്യങ്ങളിലും ആയി അഞ്ഞൂറിൽ അധികം കുടുംബങ്ങൾ പാർക്കുന്നു.',
  history_para3_en: 'The Kuzhimattam branch has five sub-branches through five ancestors: Naduvileddam, Karanikulam, Kizhakkekkutt, Chelachira, and Valyavettil. The Thottakad branch has seven sub-branches through seven ancestors: Thanangumpathickal, Kizhakkemuri, Chirathalakkal, Mattathil, Thanangumpathickal East, Thanangumpathickal West, and Chirappurath. More than five hundred families are settled in Thottakad, Kuzhimattam areas, as well as in Kumily, Malabar regions, other parts of Kerala, various states of India, and many countries around the world.',

  history_para4_ml: '1936-ൽ കുടുംബ യോഗം ആരംഭിക്കുകയും 1977-ൽ കുടുംബ ചരിത്രത്തിൻ്റെ ഒന്നാം വാല്യവും. 1999-ൽ രണ്ടാം വാല്യവും പ്രസിദ്ധീകരിക്കുകയും ചെയ്തു .',
  ...
  history_para5_ml: 'കുടുംബ യോഗത്തിൻ്റെ നവതി വർഷത്തോടനുബന്ധിച്ച് 2026-ൽ ആരംഭിച്ച ഈ വെബ്സൈറ്റ്, കുടുംബ ബന്ധങ്ങൾ സുദൃഢമാക്കുന്നതിനും പരസ്പരം കൂടുതൽ മനസ്സിലാക്കുന്നതിനും ഇടയാക്കട്ടെ എന്ന് പ്രാർത്ഥിക്കുകയും, ആശംസിക്കുകയും ചെയ്യുന്നു.',
  history_para5_en: 'This website, launched in 2026 to commemorate the 90th anniversary of family meetings, is hoped and prayed to strengthen family bonds and foster mutual understanding.',

  // About page content
  about_subtitle_ml: 'വിശ്വാസവും, പാരമ്പര്യവും ഒരുമിച്ച കുടുംബ ചരിത്രം',
  about_subtitle_en: 'A History of Faith, Tradition, and Family Unity',

  about_para1_ml: 'കേരളത്തിലെ പ്രാചീന കുടുംബങ്ങളിൽപ്പെട്ട ക്രിസ്ത്യാനികളെല്ലാം തന്നെ, തങ്ങളുടെ ഉത്ഭവം മാർത്തോമ്മാ ശ്ലീഹാ എ.ഡി 52-ൽ ഇവിടെ വന്നത് മുതലാണെന്ന് അവകാശപ്പെടുന്നവരും, അതിൽ അഭിമാനിക്കുന്നവരുമാണ്. ഒന്നാം നൂറ്റാണ്ടു മുതൽ ആധുനിക കാലം വരെയുള്ള പ്രസ്തുത ചരിത്രത്തിൻ്റെ കണ്ണികൾ ഇടമുറിയാതെ ചേർത്ത് വയ്ക്കുക എന്നത് സുസാധ്യമല്ല.  1977-ൽ പ്രസിദ്ധീകരിച്ച  ചിറപ്പുറത്ത് കുടുംബചരിത്ര ഗ്രന്ഥത്തിൽ, കിട്ടാവുന്ന എല്ലാ ചരിത്രരേഖകളും, പൂർവ്വീകന്മാരിൽ നിന്നും പരമ്പരാഗതമായി ലഭിച്ചിട്ടുള്ള വിവരങ്ങളും ക്രോഡീകരിച്ച് അവയുടെ അടിസ്ഥാനത്തിൽ ആധുനിക കാലഘട്ടത്തെ സവിസ്തരം പ്രതിപാദിക്കുവാൻ ശ്രമിച്ചിട്ടുണ്ട്.',
  ...
  about_para2_ml: 'മാർത്തോമ്മാ ശ്ലീഹാ മലയാളക്കരയിൽ വന്നിറങ്ങിയതിനു ശേഷം കൊടുങ്ങല്ലൂർ, പാലയൂർ, പറവൂർ, നിരണം, കൊല്ലം, തെക്കൻ പള്ളിപ്പുറം, നിലയ്ക്കൽ എന്നീ സ്ഥലങ്ങളിൽ പള്ളികൾ സ്ഥാപിച്ചതായും കള്ളി, കാളിയാങ്കൽ, ശങ്കരപുരി, പകലോമറ്റം എന്നീ ബ്രാഹ്മണ കുടുംബങ്ങളെ ക്രിസ്തു മതത്തിലേക്ക് പരിവർത്തനം ചെയ്യിച്ചതായും അവരിൽ നിന്ന് അപ്പോസ്തോലിക മാതൃകയിൽ കൈവെപ്പോടുകൂടി വൈദീകരെ സഭാ ശുശ്രൂഷയ്ക്കായി പ്രതിഷ്ഠിച്ചതായും വിശ്വസിക്കുന്നു. അതിൽ കള്ളി ഇല്ലക്കാരിൽ ചിലർ വിവിധ കാരണങ്ങളാൽ എ.ഡി 337-ൽ പാലയൂരിൽ നിന്നും പുറപ്പെട്ട് കുറവലങ്ങാട്ട് വന്നു താമസിച്ചെന്നും എ.ഡി 345-ൽ ക്നായിതൊമ്മൻ്റെ കൂടെ വന്ന ജോസഫ് മെത്രാൻ അവർക്ക് ഒരു പള്ളി കൂദാശ ചെയ്തു കൊടുത്തെന്നും " മാർത്തോമ്മാ ശ്ലീഹായുടെ ചരിത്രം" എന്ന ഗ്രന്ഥത്തിൽ രേഖപ്പെടുത്തിയിട്ടുണ്ട്. അവിടെ നിന്നും ഇന്നേക്ക് ഏതാണ്ട് 500 വർഷങ്ങൾക്കു മുമ്പ് കള്ളി ഇല്ലത്ത് ഭവനത്തിലെ കുരുവിള എന്ന് ആൾ തോട്ടയ്ക്കാട്ട് വന്നു താമസം തുടങ്ങി. പതിനഞ്ചാം നൂറ്റാണ്ടിൻ്റെ അവസാനമോ, പതിനാറാം നൂറ്റാണ്ടിൻ്റെ ആരംഭത്തിലോ തോട്ടയ്ക്കാട് വന്നു പാർത്ത കള്ളിയില്ലത്ത് കുരുവിള ആണ് നമ്മുടെ കുടുംബ പിതാവായി കണ്ടെത്താൻ കഴിയുന്നത്. ഇല്ലപ്പേര് അദ്ദേഹം സ്വീകരിച്ചെങ്കിലും പിൽക്കാലത്ത് ഈ വീട്ടുപേര് " കണ്ണൊഴുക്കത്ത് " എന്ന് രൂപാന്തരപ്പെട്ടു. തോട്ടയ്ക്കാട് താമസം തുടങ്ങിയ കണ്ണൊഴുക്കം എന്ന് പിന്നീട് അറിയപ്പെട്ട കള്ളി ഇല്ലത്ത് കുരുവിളയുടെ ഏഴാം തലമുറക്കാരനായ ചിറപ്പുറത്ത് കുരുവിള മുതലുള്ള ചരിത്രമാണ് കുടുംബ ചരിത്രമായി പ്രസിദ്ധീകരിച്ചിരിക്കുന്നത്.',
  about_para2_en: 'It is believed that after St. Thomas landed on the Malabar coast, he established churches in Kodungallur, Palayoor, Paravoor, Niranam, Kollam, Thekkan Pallippuram, and Nilaykal, and converted the Brahmin families of Kalli, Kaliyangal, Sankarapuri, and Palamattathu to Christianity, ordaining priests from among them through apostolic laying of hands for church ministry. It is recorded in the book "History of St. Thomas the Apostle" that some members of the Kalli household left Palayoor in AD 337 for various reasons and settled in Kuravilangad, and that Bishop Joseph, who came with Knai Thommen in AD 345, consecrated a church for them. From there, about 500 years ago, a person named Kuruvila from the Kalli household came and began residing in Thottakad. Kalli household\'s Kuruvila, who settled in Thottakad in the late 15th or early 16th century, is the identifiable family patriarch. Although he took the house name, it later transformed to "Kannozhukkathu". The published family history begins with Chirappurath Kuruvila, the seventh generation descendant of Kalli household Kuruvila, later known as Kannozhukam, who began residing in Thottakad.',
  ...
  about_para4_en: 'The Chirappurath family, one of the prominent families in Central Travancore, has two branches: Thottakad and Kuzhimattam. Among the five sons of Chirappurath Kuruvila, the seventh generation descendant of Kalli household Kuruvila who settled in Thottakad, the third son Varki became the head of the Kuzhimattam branch and the youngest son Kuruvila became the head of the Thottakad branch. The other three ancestors had only daughters, who were married into the Padinjaremurei, Kadappoor, and Kannozhukam families respectively.',

  about_para5_ml: 'കുഴിമറ്റം ശാഖാ തലവൻ വർക്കിയുടെ മക്കളായ അഞ്ച് പിതാക്കന്മാരിലൂടെ നടുവിലേടം, കാരാണിക്കുളം, കിഴക്കേക്കുറ്റ്, ചേലചിറ, വല്യവീട്ടിൽ എന്നീ അഞ്ച് ഉപശാഖകളും,  തോട്ടയ്ക്കാട് ശാഖാ തലവൻ കുരുവിളയുടെ മക്കളായ ഏഴ് പിതാക്കന്മാരിലൂടെ തണുങ്ങുംപതിയ്ക്കൽ, കിഴക്കേ മുറിയിൽ, ചിറത്തലയ്ക്കൽ, മറ്റത്തിൽ, തണുങ്ങുംപതിയ്ക്കൽ കിഴക്ക്, തണുങ്ങുംപതിയ്ക്കൽ പടിഞ്ഞാറ്, ചിറപ്പുറത്ത് എന്നീ ഏഴ് ഉപശാഖകളും ഉണ്ട്.',
  ...
  september_ml: 'സെപ്റ്റംബർ',
  september_en: 'September',

  // News page content
  news_and_events_title_ml: 'വാർത്തകളും പരിപാടികളും',
  news_and_events_title_en: 'News and Events',
  ...
  events_label_ml: 'പരിപാടികൾ',
  events_label_en: 'Events',

  announcements_label_ml: 'അറിയിപ്പുകൾ',
  announcements_label_en: 'Announcements',

  news_item_ml: 'വാർത്ത',
  news_item_en: 'News',

  event_item_ml: 'പരിപാടി',
  event_item_en: 'Event',

  announcement_item_ml: 'അറിയിപ്പ്',
  announcement_item_en: 'Announcement',

  read_more_ml: 'കൂടുതൽ വായിക്കുക',
  read_more_en: 'Read More',

  no_news_available_ml: 'വാർത്തകളൊന്നും ലഭ്യമല്ല',
  no_news_available_en: 'No news available',
...
function t(key, lang = 'ml') {
  const translationKey = `${key}_${lang}`;
  return translations[translationKey] || translations[`${key}_ml`] || key;
}
